...
1005,550
 ...
 if(mas[1])
 {
   setfillstyle(1,8); fillpoly(3,poly1);
   outxy(700-10, 110, mas[1]);
  }
  for(int i=1; i < n; i++)
    {
      switch(i)
      {
        case 1: if(mas[2]>mas[3]) {setfillstyle(1,8);fillpoly(4,poly3);outxy(700-100, 260, mas[2]);} else outxy(700-100, 260, mas[2]); break;
        case 2: if(mas[3]>mas[2]){setfillstyle(1,8);fillpoly(4,poly2);outxy(700+100, 260, mas[3]);} else outxy(700+100, 260, mas[3]); break;
        case 3: if(mas[4]) {setfillstyle(1,4);fillpoly(4,poly4);outxy(700-250, 420, mas[4]);} else outxy(700-250, 420, mas[4]); break;
        case 4: if(mas[5]) {setfillstyle(1,4);fillpoly(4,poly5);outxy(700-100, 420, mas[5]);} else outxy(700-100, 420, mas[5]);break;
        case 5: if(mas[6]) {setfillstyle(1,4);fillpoly(4,poly6);outxy(700+80, 420, mas[6]);}break;
        case 6: if(mas[7]) {setfillstyle(1,4);fillpoly(4,poly7);outxy(700+250, 420,mas[7]);}break;
        case 7: if(mas[8]) {setfillstyle(1,7);fillpoly(4,poly8);outxy(700-390, 570, mas[8]);}break;
        case 8: if(mas[9]) {setfillstyle(1,7);fillpoly(4,poly9);outxy(700-290, 570, mas[9]);}break;
        case 9:if(mas[10]) {setfillstyle(1,7);fillpoly(4,poly10);outxy(700-180, 570, mas[10]);}break;
        case 10:if(mas[11]) {setfillstyle(1,7);fillpoly(4,poly11);outxy(700-70, 570, mas[11]);}break;
        case 11:if(mas[12]) {setfillstyle(1,7);fillpoly(4,poly12);outxy(700+50, 570, mas[12]);}break;
        case 12:if(mas[13]) {setfillstyle(1,7);fillpoly(4,poly13);outxy(700+150, 570, mas[13]);}break;
        case 13:if(mas[14]) {setfillstyle(1,7);fillpoly(4,poly14);outxy(700+260, 570, mas[14]);}break;
        case 14:if(mas[15]) {setfillstyle(1,7);fillpoly(4,poly15);outxy(700+370, 570, mas[15]);}break;
      }
    }
}
...
void fillHeap(void)
{
    ...
    for (int i = 0; i< n; i++) HeapAdd1( rand()%100+1);
}
...
int main()
{
    ...
    cout<<"Vvedite razmer kuchi: ";
    cin>>n;

    fillHeap();
    interfeis(heap);
    cout<<" Najmite lubuyu klavishu, chtobi\nudalit' max element"<<endl;
    ...
    cin>>tmp;
    HeapAdd(tmp);
    cout<<"Element "<<tmp<<" dobavlen v kuchu"<<endl;
    interfeis(heap);
